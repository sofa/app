...
angular
    ...
    .controller('SummaryController', function ($scope, navigationService, checkoutService, dialog, $stateParams, trustedShopsService, $state, snapRemote, basketService, titleService) {
