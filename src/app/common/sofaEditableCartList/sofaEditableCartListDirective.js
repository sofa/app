...
angular
    .module('sofa.editableCartList')
    .directive('sofaEditableCartList', function ($templateCache) {
        return {
            restrict: 'E',
            scope: true,
            compile: function (tElement, tAttrs) {
                ...
                var tpl = angular.element($templateCache.get('common/sofaEditableCartList/sofa-editable-cart-list.tpl.html'));
                ...
                return {
                    post: function (scope, element, attrs) {
                        ...
                        var increaseFn = scope.$eval(attrs.onIncrease);
                        var decreaseFn = scope.$eval(attrs.onDecrease);
