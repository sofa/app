...
angular
    ...
    .controller('ProductsController', function ($scope, $stateParams, navigationService, backStepHighlightService, products, category, selectionService, categoryTreeViewRemote, productService, titleService) {
