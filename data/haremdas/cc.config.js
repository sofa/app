cc.Config = {
    ...
    checkoutUrl:'http://haremdas.couchcommerce.com/checkout/v3/',
    apiHttpMethod: 'jsonp',
    categoryJson: 'data/haremdas/categories.json',
    //apiUrl: 'data/dasgibtesnureinmal/products.json',
    //apiHttpMethod: 'get',
    mediaFolder:'https://cc1.couchcommerce.com/media/haremdas/img/',
