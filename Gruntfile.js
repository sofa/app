        ...
        shell: {
            dist: {
                ...
                command: function(){
                    ...
                    //return 'git add -A && git add -f dist && git add -f node_modules/sofa-base && git commit -m "chore(*): adding dist folder for ' + version + ' release"';
                    return 'git add -A && git add -f dist && git add -f node_modules/sofa-base && git commit -m "chore(*): adding dist folder for ' + version + ' release" && git tag ' + version + ' && git push --tags';
                }
            }
        },
        changelog: {
